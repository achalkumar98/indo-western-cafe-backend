...
router.get(
  ...
  catchAsync(async (req, res) => {
    ...
    if (!placeId || !mapsApiKey) {
      ...
      throw new ApiError(httpStatus.SERVICE_UNAVAILABLE, 'Google reviews not configured. Set GOOGLE_PLACE_ID and GOOGLE_MAPS_API_KEY.');
    }
    ...
    if (googleData.status !== 'OK') {
      ...
      throw new ApiError(httpStatus.BAD_GATEWAY, `Google Places error: ${googleData.status}`);
    }
